...
import be.kdg.dishsg.order.adapters.in.dto.BusynessResponse;
...
// Public REST controller for customers to place orders, track order status, and check restaurant busyness.
@RestController
