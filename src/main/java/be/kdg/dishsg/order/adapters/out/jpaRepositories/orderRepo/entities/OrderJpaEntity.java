package be.kdg.dishsg.order.adapters.out.jpaRepositories.orderRepo.entities;
...
// JPA projection entity for orders; used for list and count queries alongside the event store.
@Entity
@Table(name = "orders")
