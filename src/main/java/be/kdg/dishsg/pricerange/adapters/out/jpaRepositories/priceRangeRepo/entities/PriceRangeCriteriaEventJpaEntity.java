package be.kdg.dishsg.pricerange.adapters.out.jpaRepositories.priceRangeRepo.entities;

import jakarta.persistence.*;
import java.time.LocalDateTime;
import java.util.UUID;

// JPA entity storing a price range criteria event (thresholds defining CHEAP/REGULAR/EXPENSIVE/PREMIUM).
@Entity
