package be.kdg.dishsg.restaurant.adapters.out.geocodingAdapter;
...
// Geocodes an address using the Nominatim (OpenStreetMap) API; returns null on failure (best-effort).
@Component
