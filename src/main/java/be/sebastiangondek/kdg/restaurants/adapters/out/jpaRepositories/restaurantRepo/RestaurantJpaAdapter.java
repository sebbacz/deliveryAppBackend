...
import be.sebastiangondek.kdg.restaurants.adapters.out.jpaRepositories.restaurantRepo.entities.AddressEmbeddable;
...
// Maps Restaurant domain objects to/from JPA entities.
@Component
