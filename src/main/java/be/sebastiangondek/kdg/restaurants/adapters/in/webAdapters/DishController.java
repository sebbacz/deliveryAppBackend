...
import be.sebastiangondek.kdg.restaurants.adapters.in.webAdapters.requests.DishDraftRequest;
import be.sebastiangondek.kdg.restaurants.adapters.in.webAdapters.requests.ScheduleChangesRequest;
...
import be.sebastiangondek.kdg.restaurants.ports.in.*;
...
// Owner-only REST controller for the full dish lifecycle: drafts, publish/unpublish, stock, and scheduled changes.
@RestController
